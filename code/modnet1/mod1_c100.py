...
for _ in range(5):
    ...
    ax1.set_title('Accuracy on ModNet1-C100 with Different Weight Initializers')
    ax2.set_xlabel('Epochs')
    ax2.set_ylabel('Loss')
    ax2.set_title('Loss on ModNet1-C100 with Different Weight Initializers')
    plt.legend()
    ...
    # Save the plot
    plt.savefig(f'mod1_c100_{_+1}.png', dpi='figure')
    plt.close()
