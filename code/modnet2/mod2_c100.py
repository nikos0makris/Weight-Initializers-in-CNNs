...
for _ in range(5):
    ...
    ax1.set_title('Accuracy on ModNet2-C100 with Different Weight Initializers')
    ax2.set_xlabel('Epochs')
    ax2.set_ylabel('Loss')
    ax2.set_title('Loss on ModNet2-C100 with Different Weight Initializers')
    plt.legend()
    ...
    # Save the plot
    plt.savefig(f'mod2_c100_{_+1}.png', dpi='figure')
    plt.close()
